                    ...
                    <div className='flex flex-col pb-4 leading-loose'>
                      <h1  className='font-semibold text-2xl float-left pr-2'>   Ajker Rashifal: বাঙালি দৈনিক রাশিফল - 6 March 2024 </h1>
                       <br>
                                 ...
                                 <h1 className='font-semibold text-2xl float-left pr-2'>	মীন রাশি 	</h1>	<p>	 অর্থ আসতে পারে। রিলেশন এ খুব ভালো সময়। প্রেমে প্রপোজ করুন পজিটিভ উত্তর আসতে পারে। পড়াশুনায় ফোকাস হারাবেন না। রিস্ক কিছু নেবেন না। ইচ্ছা পূর্তি হবে।	
